...
const TEAM_VALUES = [
  { icon: Globe, title: "Présence internationale", desc: "Équipes hautement qualifiées basées en Europe, en Asie et en Afrique" },
  { icon: Search, title: "Recherche et développement", desc: "Capacité d'innovation continue au service des administrations partenaires" },
  { icon: GraduationCap, title: "Expertise de haut niveau", desc: "Ingénieurs et spécialistes issus d'institutions académiques de référence" },
  { icon: ShieldCheck, title: "Sécurité opérationnelle", desc: "Architecture sécurisée, redondante et adaptée aux environnements critiques" },
];
